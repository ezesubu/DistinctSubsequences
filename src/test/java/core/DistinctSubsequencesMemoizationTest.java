...
import main.java.core.DistinctSubsequencesMemoization;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class DistinctSubsequencesMemoizationTest {

    DistinctSubsequencesMemoization ds;

    @BeforeEach
    void setUp() {
        ds = new DistinctSubsequencesMemoization();
    }
    @Test
    void testExample1() {
        String s = "rabbbit";
